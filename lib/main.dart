...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Material App',
      home: const Example8Page(),
      routes: {
        Example8Page.routeName: (context) => const Example8Page(),
        ...
        child: Column(
          children: [
            ...
            TextButton(
              child: const Text("Example 6"),
              onPressed: () =>
                  Navigator.of(context).pushNamed(Example8Page.routeName),
            ),
          ],
        ),
      ),
